...
class __TwigTemplate_733fd4e7125e63d066f29c406faf52574288c9aedfb537e3ba409e349fa22370 extends \XLite\Core\Templating\Twig\Template
{
  ...
  <div class=\"progress-status\">
    ...
    {
        return new Twig_Source("<div class=\"onboarding-wizard-mini-informer\" id=\"wizard-mini-status\">
  <div class=\"progress-circle\" data-value=\"{{ this.getCurrentProgress() / 100.0 }}\"></div>
  <div class=\"progress-status\">
    <div class=\"status-message\">{{ this.getStatusMessage() }}</div>
    {{ widget('XLite\\\\View\\\\Button\\\\SimpleLink', label=t(this.getButtonLabel()), location=this.getWizardUrl(), attributes={'data-progress': this.getCurrentProgress()}) }}
  </div>
</div>", "modules/XC/Onboarding/mini_wizard_status/body.twig", "E:\\Server\\projects\\x-cart\\skins\\admin\\modules\\XC\\Onboarding\\mini_wizard_status\\body.twig");
    }
}
