...
/* E:\Server\projects\x-cart\skins\admin\center.twig */
class __TwigTemplate_6afdaf24d7ae6787099db11240961412d213ef23515996530599582660f71025 extends \XLite\Core\Templating\Twig\Template
{
...
echo $templateWrapperStart;
        ...
        // line 6
        $this->loadTemplate("noscript.twig", "E:\\Server\\projects\\x-cart\\skins\\admin\\center.twig", 6)->display($context);
        if ($templateWrapperText) {
...
echo $templateWrapperStart;
            ...
            $this->loadTemplate("access_denied.twig", "E:\\Server\\projects\\x-cart\\skins\\admin\\center.twig", 19)->display($context);
            if ($templateWrapperText) {
                echo $this->getThis()->endMarker($fullPath, $templateWrapperText);
            }
        }
...
echo $templateWrapperStart;
            ...
            $this->loadTemplate("license_message.twig", "E:\\Server\\projects\\x-cart\\skins\\admin\\center.twig", 23)->display($context);
            if ($templateWrapperText) {
                echo $this->getThis()->endMarker($fullPath, $templateWrapperText);
            }
        }
...
";
    ...
    {
        return "E:\\Server\\projects\\x-cart\\skins\\admin\\center.twig";
    }
    ...
    {
        return new Twig_Source("", "E:\\Server\\projects\\x-cart\\skins\\admin\\center.twig", "");
    }
}
