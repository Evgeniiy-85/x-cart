 ...
 */
class AttributeValueHidden extends \XLite\Model\AttributeValue\AttributeValueHidden implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'attribute_option', 'id', 'product', 'attribute', 'editLanguage', 'translations', '_previous_state'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AttributeValueHidden $proxy) {
    ...
    public function setAttributeOption(\XLite\Model\AttributeOption $attributeOption = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAttributeOption', [$attributeOption]);
    ...
    public function getAttributeOption()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAttributeOption', []);
