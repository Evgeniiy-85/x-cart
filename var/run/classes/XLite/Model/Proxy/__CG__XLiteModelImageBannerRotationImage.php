...
class BannerRotationImage extends \XLite\Model\Image\BannerRotationImage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'bannerRotationSlide', 'alt', 'width', 'height', 'hash', 'needProcess', 'includeFilenameInHash', 'id', 'path', 'fileName', 'mime', 'storageType', 'size', 'date', 'loadError', 'loadErrorMessage', '_previous_state'];
        }
    ...
    public function setBannerRotationSlide(\XLite\Model\BannerRotationSlide $bannerRotationSlide = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBannerRotationSlide', [$bannerRotationSlide]);
    ...
    public function getBannerRotationSlide()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBannerRotationSlide', []);
