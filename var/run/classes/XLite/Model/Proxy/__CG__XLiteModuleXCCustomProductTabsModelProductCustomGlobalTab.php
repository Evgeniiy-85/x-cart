 ...
 */
class CustomGlobalTab extends \XLite\Module\XC\CustomProductTabs\Model\Product\CustomGlobalTab implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'global_tab', 'editLanguage', 'translations', '_previous_state'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CustomGlobalTab $proxy) {
