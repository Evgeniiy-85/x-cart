 ...
 */
class MessageRead extends \XLite\Module\XC\VendorMessages\Model\MessageRead implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'date', 'message', 'reader', '_previous_state'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MessageRead $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setMessage(\XLite\Module\XC\VendorMessages\Model\Message $message)
    {
    ...
    public function isOwn($profile)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isOwn', [$profile]);

        return parent::isOwn($profile);
    }
