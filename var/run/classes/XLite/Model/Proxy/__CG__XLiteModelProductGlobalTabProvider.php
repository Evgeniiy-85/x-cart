 ...
 */
class GlobalTabProvider extends \XLite\Model\Product\GlobalTabProvider implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'tab', 'code', '_previous_state'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GlobalTabProvider $proxy) {
    ...
    public function checkProvider()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'checkProvider', []);

        return parent::checkProvider();
    }
