...
namespace XLite\Model\Proxy\__CG__\XLite\Module\CDev\FileAttachments\Model\Product\Attachment;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Storage extends \XLite\Module\CDev\FileAttachments\Model\Product\Attachment\Storage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'attachment', 'id', 'path', 'fileName', 'mime', 'storageType', 'size', 'date', 'loadError', 'loadErrorMessage', '_previous_state'];
        }
    ...
    public function cloneEntityForAttachment(\XLite\Module\CDev\FileAttachments\Model\Product\Attachment $attachment)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'cloneEntityForAttachment', [$attachment]);

        return parent::cloneEntityForAttachment($attachment);
    }
