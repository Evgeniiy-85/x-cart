...
class FormId extends \XLite\Model\FormId implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'form_id', 'date', 'session', '_previous_state'];
        }
    ...
    public function setDate($value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDate', [$value]);
    ...
    public function prepareFormId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'prepareFormId', []);
