...
class Property extends \XLite\Model\Order\Status\Property implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'paymentStatus', 'shippingStatus', 'incStock', '_previous_state'];
        }
    ...
    public function setIncStock($incStock)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIncStock', [$incStock]);
    ...
    public function getIncStock()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIncStock', []);
