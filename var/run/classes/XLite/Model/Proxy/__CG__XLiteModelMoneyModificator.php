...
class MoneyModificator extends \XLite\Model\MoneyModificator implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'class', 'modificator', 'validator', 'position', 'behavior', 'purpose', '_previous_state'];
        }
    ...
    public function apply($value, \XLite\Model\AEntity $model, $property, array $behaviors, $purpose)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'apply', [$value, $model, $property, $behaviors, $purpose]);
    ...
    public function setModificator($modificator)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setModificator', [$modificator]);
    ...
    public function getModificator()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getModificator', []);
