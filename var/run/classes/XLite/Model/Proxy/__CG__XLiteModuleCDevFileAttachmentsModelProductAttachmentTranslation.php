 ...
 */
class AttachmentTranslation extends \XLite\Module\CDev\FileAttachments\Model\Product\AttachmentTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'title', 'description', 'label_id', 'code', 'owner', '_previous_state'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AttachmentTranslation $proxy) {
