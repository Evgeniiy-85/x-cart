...
namespace XLite\Model\Proxy\__CG__\XLite\Model\Job;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class State extends \XLite\Model\Job\State implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'progress', 'startedAt', 'cancelled', 'finished', 'data', '_previous_state'];
        }
    ...
    public function getData($name = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getData', [$name]);
    ...
    public function setData($name = NULL, $value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setData', [$name, $value]);
    ...
    public function toArrayForNative()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'toArrayForNative', []);

        return parent::toArrayForNative();
    }
