...
namespace XLite\Model\Proxy\__CG__\XLite\Model\Product;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class GlobalTab extends \XLite\Model\Product\GlobalTab implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GlobalTab $proxy) {
    ...
    public function addProvider($provider)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addProvider', [$provider]);
    ...
    public function getProviderByCode($code)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProviderByCode', [$code]);

        return parent::getProviderByCode($code);
    }
