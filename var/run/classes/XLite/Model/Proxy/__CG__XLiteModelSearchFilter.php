...
class SearchFilter extends \XLite\Model\SearchFilter implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'filterKey', 'parameters', 'suffix', 'editLanguage', 'translations', '_previous_state'];
        }
    ...
    public function setFilterKey($filterKey)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFilterKey', [$filterKey]);
    ...
    public function getFilterKey()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFilterKey', []);
