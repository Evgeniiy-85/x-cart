...
namespace XLite\Model\Proxy\__CG__\XLite\Model\Image\Common;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Logo extends \XLite\Model\Image\Common\Logo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'width', 'height', 'hash', 'needProcess', 'includeFilenameInHash', 'id', 'path', 'fileName', 'mime', 'storageType', 'size', 'date', 'loadError', 'loadErrorMessage', '_previous_state'];
        }
