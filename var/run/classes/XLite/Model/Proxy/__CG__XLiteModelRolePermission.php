...
class Permission extends \XLite\Model\Role\Permission implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'code', 'section', 'roles', 'editLanguage', 'translations', '_previous_state'];
        }
    ...
    public function isAllowed($code)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isAllowed', [$code]);
