 ...
 */
class AttributeValueHiddenTranslation extends \XLite\Model\AttributeValue\AttributeValueHiddenTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'label_id', 'code', 'owner', '_previous_state'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AttributeValueHiddenTranslation $proxy) {
