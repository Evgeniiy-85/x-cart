...
namespace XLite\Model\Proxy\__CG__\XLite\Module\XC\ProductTags\Model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class TagTranslation extends \XLite\Module\XC\ProductTags\Model\TagTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'name', 'label_id', 'code', 'owner', '_previous_state'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TagTranslation $proxy) {
