...
namespace XLite\Model\Proxy\__CG__\XLite\Module\EA\ProductRecommendations\Model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Recommendation extends \XLite\Module\EA\ProductRecommendations\Model\Recommendation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'additionDate', 'status', 'quote', 'source_name', 'source_link', 'product', '_previous_state'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Recommendation $proxy) {
