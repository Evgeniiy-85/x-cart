...
class VolumeDiscount extends \XLite\Module\CDev\VolumeDiscounts\Model\VolumeDiscount implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'value', 'type', 'subtotalRangeBegin', 'subtotalRangeEnd', 'membership', '_previous_state'];
        }
    ...
    public function setSubtotalRangeEnd($subtotalRangeEnd)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSubtotalRangeEnd', [$subtotalRangeEnd]);
    ...
    public function getSubtotalRangeEnd()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSubtotalRangeEnd', []);
