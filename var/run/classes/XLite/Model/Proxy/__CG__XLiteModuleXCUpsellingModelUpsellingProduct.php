...
class UpsellingProduct extends \XLite\Module\XC\Upselling\Model\UpsellingProduct implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'orderBy', 'product', 'parentProduct', '_previous_state'];
        }
    ...
    public function getBidirectional()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBidirectional', []);
    ...
    public function setBidirectional($newValue)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBidirectional', [$newValue]);
