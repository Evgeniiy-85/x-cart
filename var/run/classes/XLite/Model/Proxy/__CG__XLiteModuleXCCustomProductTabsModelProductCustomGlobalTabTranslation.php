 ...
 */
class CustomGlobalTabTranslation extends \XLite\Module\XC\CustomProductTabs\Model\Product\CustomGlobalTabTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'name', 'brief_info', 'content', 'label_id', 'code', 'owner', '_previous_state'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CustomGlobalTabTranslation $proxy) {
    ...
    public function setBriefInfo($brief_info)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBriefInfo', [$brief_info]);

        return parent::setBriefInfo($brief_info);
    }
