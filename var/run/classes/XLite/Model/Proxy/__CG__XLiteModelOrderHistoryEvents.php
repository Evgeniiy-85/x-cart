...
class OrderHistoryEvents extends \XLite\Model\OrderHistoryEvents implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'event_id', 'date', 'code', 'description', 'data', 'comment', 'details', 'order', 'author', 'authorName', 'authorIp', '_previous_state'];
        }
    ...
    public function getAuthorIp()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAuthorIp', []);
    ...
    public function setAuthorIp($authorIp)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAuthorIp', [$authorIp]);
    ...
    public function showAuthor()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'showAuthor', []);
