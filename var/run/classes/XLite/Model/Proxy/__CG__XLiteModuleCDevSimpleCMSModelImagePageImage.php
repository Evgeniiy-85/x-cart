...
class Image extends \XLite\Module\CDev\SimpleCMS\Model\Image\Page\Image implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'page', 'width', 'height', 'hash', 'needProcess', 'includeFilenameInHash', 'id', 'path', 'fileName', 'mime', 'storageType', 'size', 'date', 'loadError', 'loadErrorMessage', '_previous_state'];
        }
