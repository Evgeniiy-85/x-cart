...
class LanguageLabel extends \XLite\Model\LanguageLabel implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'label_id', 'name', 'editLanguage', 'translations', '_previous_state'];
        }
    ...
    public function getLabelTranslation($code = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLabelTranslation', [$code]);
