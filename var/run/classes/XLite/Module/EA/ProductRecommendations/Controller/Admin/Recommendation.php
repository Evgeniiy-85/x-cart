...
{
    /**
     * Return Product Recommendation id from request
     *
     * @return integer
     */
    ...
    {
        $result = \XLite\Core\Database::getRepo('\XLite\Module\EA\ProductRecommendations\Model\Recommendation')->find($this->getId());

        return $result ? : new \XLite\Module\EA\ProductRecommendations\Model\Recommendation();
    }
    ...
    {
        return 'XLite\Module\EA\ProductRecommendations\View\Model\Recommendation';
    }
}
