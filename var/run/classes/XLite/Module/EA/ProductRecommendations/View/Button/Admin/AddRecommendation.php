...
class AddRecommendation extends \XLite\View\Button\APopupButton
{
    ...
    public function getJSFiles()
    {
        ...
        $list[] = 'modules/EA/ProductRecommendations/button/js/add_recommendation/func.js';
        $list[] = 'modules/EA/ProductRecommendations/button/js/add_recommendation/controller.js';
