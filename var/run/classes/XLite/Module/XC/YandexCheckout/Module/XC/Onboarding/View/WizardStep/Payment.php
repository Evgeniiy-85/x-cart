 ...
 */
 class Payment extends \XLite\Module\XC\Onboarding\View\WizardStep\PaymentAbstract implements \XLite\Base\IDecorator
{
    protected function getOnlineWidgets()
    {
        return array_merge(parent::getOnlineWidgets(), [
            '\XLite\Module\XC\YandexCheckout\View\Onboarding\Payment',
        ]);
    }
}