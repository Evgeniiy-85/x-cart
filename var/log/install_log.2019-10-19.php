...
--------------------------------------------------------------------
[Sat, 19 Oct 19 17:23:53 +0300]
[X-Cart v5.4.0.5]
[GET, HTTP/1.1] http://x-cart.local:80//install.php
[Apache]
Debug info
array (
)
...
--------------------------------------------------------------------
[Sat, 19 Oct 19 17:23:57 +0300]
[X-Cart v5.4.0.5]
[POST, HTTP/1.1] http://x-cart.local:80//install.php
[Apache]
Debug info
array (
  'params' => 
...
array (
  'params' => 
  array (
    'login' => 'evgeniy.aynulov85@yandex.ru',
    'password' => '<specified>',
    'new_installation' => '2',
  ),
  'go_back' => '0',
...
array (
  ...
  array (
    ...
    'data' => 
    array (
      'configPath' => 'E:\\Server\\projects\\x-cart\\etc\\',
  ...
  array (
    ...
    'status' => true,
    'critical' => false,
    'value' => 'libcurl 7.56.0, OpenSSL/1.1.0g',
    'data' => 
    array (
      'version' => 'libcurl 7.56.0, OpenSSL/1.1.0g',
    ),
    'messageData' => 
    array (
      ':version' => 'libcurl 7.56.0, OpenSSL/1.1.0g',
...
array (
  ...
  array (
    ...
    'xlite_http_host' => 'x-cart.local',
    'xlite_https_host' => 'x-cart.local',
    'xlite_web_dir' => '/',
    'date_default_timezone' => 'Europe/Samara',
    'login' => 'evgeniy.aynulov85@yandex.ru',
    'password' => '<specified>',
    'new_installation' => '2',
    'requirements_success' => '1',
...
[POST, HTTP/1.1] http://x-cart.local:80//install.php
[Apache]
The specified database "xc5" not found
...
[POST, HTTP/1.1] http://x-cart.local:80//install.php
[Apache]
The database "xc5" successfully created.


--------------------------------------------------------------------
[Sat, 19 Oct 19 17:25:04 +0300]
[X-Cart v5.4.0.5]
[GET, HTTP/1.1] http://x-cart.local:80//install.php
[Apache]
Debug info
...
[Sat, 19 Oct 19 17:25:05 +0300]
[X-Cart v5.4.0.5]
[GET, HTTP/1.1] http://x-cart.local:80//install.php?target=install&action=dirs
[Apache]
Debug info
array (
  'target' => 'install',
...
--------------------------------------------------------------------
[Sat, 19 Oct 19 17:25:09 +0300]
[X-Cart v5.4.0.5]
[POST, HTTP/1.1] http://x-cart.local:80//install.php
[Apache]
inst_http_request() result
array (
  'url_request' => 'http://x-cart.local/check/for/clean/urls.html',
  ...
  PEAR2\HTTP\Request\Response::__set_state(array(
    ...
    PEAR2\HTTP\Request\Headers::__set_state(array(
       ...
       'fields' => 
      array (
        'Date' => 'Sat, 19 Oct 2019 14:25:09 GMT',
        'Server' => 'Apache',
        'Set-Cookie' => 'xid=yj3nrKkKOwmMea53V2yJ7L0eNEBM5Bem; expires=Sat, 26-Oct-2019 14:25:09 GMT; Max-Age=604800; path=/; samesite=lax;; domain=x-cart.local; HttpOnly',
        'Content-Length' => '2',
    ...
    array (
     ...
     'uri' => 'http://x-cart.local/check/for/clean/urls.html',
     'port' => 80,
  )),
  'response' => 'OK',
  'error' => NULL,
...
[POST, HTTP/1.1] http://x-cart.local:80//install.php
[Apache]
Файл установки переименован в install.bd6b56c0c0d9b3d2fbb098718eb01864.php


--------------------------------------------------------------------
[Sat, 19 Oct 19 17:25:10 +0300]
[X-Cart v5.4.0.5]
[POST, HTTP/1.1] http://x-cart.local:80//install.php
[Apache]
Установка завершена
